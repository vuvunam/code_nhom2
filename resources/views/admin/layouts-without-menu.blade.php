...
.phai{
  ...
  <form action="" method="POST" style="margin-left: 250px;">
    <table style="border-collapse: collapse;border:none;width: 80%;height: 450px;margin-left: auto;margin-right: auto;border-radius: 10px;border:2pc solid #288ad6;" border="1">
      <tr>
        <td colspan="2" style="background-color:#288ad6;color:#fff;text-align: center;border-top-right-radius: 8px;border-top-left-radius: 8px;padding-bottom: auto;"><p style="padding-top: -2px: ;font-size:20px;">Thêm Người Dùng</p></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <tr>
        <td colspan="2" style="text-align: center;"><button value="Thêm" class="btn btn-danger" name="them" type="submit">Thêm <i class="glyphicon glyphicon-pencil"></i></button></td>
      </tr>
