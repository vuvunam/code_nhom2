...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
        <a class="navbar-brand" href="NHOM2.html">Phạm Quang Dũng</a>
        <div class="card-body">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link " href="introduce.blade.php">Giới thiệu về trường học</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link " href="login.blade.php">Đăng nhập</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link " href="register.blade.php">Đăng ký</a>
                </li>
            </ul>
            ...
            <div class="col-sm-12 col-md-9 col-lg-9 ">
                <div class="card rounded-0 shadow-sm ">
                    <div class="card-header ">
                        ...
                        <span>On</span>
                        <span class="text-success "> 15/03/20222  Phạm Quang Dũng</span>
                    </div>
                    <style>
                    .card-body button{
                    ...
                    <div class="card-body ">
                        ...
                        <p>
                            ...
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est dicta nisi ab consequatur fugit obcaecati harum expedita, doloremque dolorem quam aut quas ad amet assumenda. Provident sunt ipsum minima autem.
                            <span id="dots">.....</span>
                        <div id="more">
